...
public class Tokenizer {
     ...
     *
     * If you paid close attention you might have realized that the regular expression for variable
     * tokens also matches any function token. This is not a bug. By storing the token information
     * in a linked list, and always ensuring that we look for matches from the beginning of the list,
     * we are giving precedence to patterns added first. If the input sequence starts
     * with alphabetic characters the function pattern will first be tested and
     * will match any one of the specified function. Only if there is no match the variable pattern
     * will be tested.
     *
    ...
    public LinkedList<Token1> getTokens() {
        return tokens;
    }
    /**
