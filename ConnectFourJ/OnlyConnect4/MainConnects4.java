...
public class MainConnects4
{
    ...
    static {
        try {
            Matrix1 = ReadMatrix("/home/florin/IdeaProjects/Viking/src/matrix1.txt");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    static {
        try {
            Matrix2 = ReadMatrix("/home/florin/IdeaProjects/Viking/src/matrix2.txt");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    static {
        try {
            Win1 = ReadMatrix("/home/florin/IdeaProjects/Viking/src/win1.txt");
        } catch(Exception e){
            e.printStackTrace();
        }
    ...
    static {
        try {
            Win2 = ReadMatrix("/home/florin/IdeaProjects/Viking/src/win2.txt");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

    public static int[][] Loss1;

    static {
        try {
            Loss1 = ReadMatrix("/home/florin/IdeaProjects/Viking/src/loss1.txt");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

    public  static int[][] Loss2;

    static {
        try {
            Loss2 = ReadMatrix("/home/florin/IdeaProjects/Viking/src/loss2.txt");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static int[][] UpdateMatrixVec(int[][] Matrix, List<int[]> vec, int increment) throws NullPointerException{
...
//        players[1] = new ComputerPlayer();
        ...
        if ( solved ) {
            ...
            if(currentPlayer == firstPlayer){
                ...
                int[][] UpMatrix1 = UpdateMatrixVec(Matrix1, Path1, 1);
                Write2FileMatrix(UpMatrix1, "/home/florin/IdeaProjects/Viking/src/matrix1.txt");

                int [][] UpWin1 = UpdateMatrixVec(Win1, Path1, 1);
                int[][] UpLoss2  = UpdateMatrixVec(Loss2, Path2, -1);
                Write2FileMatrix(UpWin1, "/home/florin/IdeaProjects/Viking/src/win1.txt");
                WriteZMatrix(UpWin1);
                Write2FileMatrix(UpLoss2, "/home/florin/IdeaProjects/Viking/src/loss2.txt");
                ...
                Write2FileMatrix(UpdateMatrixVec(Matrix2, Collections.singletonList(new int[]{rowp2b, colp2b}), decrp2b),"/home/florin/IdeaProjects/Viking/src/matrix2.txt");
...
//                UpdateMatrixVec(Matrix2, Path2, 1);
                ...
                WriteZMatrix(UpWin2);
                Write2FileMatrix(UpWin2, "/home/florin/IdeaProjects/Viking/src/win2.txt");
                int [][] UpLoss1 = UpdateMatrixVec(Loss1,  Path1, -1);
                Write2FileMatrix(UpLoss1, "/home/florin/IdeaProjects/Viking/src/loss1.txt");
...
//                Write2DMatrix2(UpdateMatrixVec(matrix2(), Path2, 1) );
                int [][] UpMatrix2 = UpdateMatrixVec(Matrix2, Path2, 1 );
                Write2FileMatrix(UpMatrix2, "/home/florin/IdeaProjects/Viking/src/matrix2.txt");
                ...
                Write2FileMatrix(UpdateMatrixVec(Matrix1, Collections.singletonList(new int[]{rowp1b, colp1b}), decrp1b), "/home/florin/IdeaProjects/Viking/src/matrix1.txt");
    ...
    public static Token[][] getCopyOfBoard()
    {
        ...
        for ( int i = 0; i < copiedBoard.length; i++ ) {
            System.arraycopy(MainConnects4.board[i], 0, copiedBoard[i], 0, copiedBoard[i].length);
        }
        return copiedBoard;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        MainConnects4 game = new MainConnects4();
