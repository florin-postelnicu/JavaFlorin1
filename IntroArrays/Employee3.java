...
public class Employee3 {
    ...
    public static class  Employees {
        ...
        public static void CheckforEntry(boolean condition) throws Exception{
        ...
        public static void CheckListOfEmployees() throws Exception {
            ...
            switch (trythis){
                ...
                {
                    Scanner scan2 = new Scanner(System.in);
                    System.out.println("Enter the person's user name ");
                ...
                case 3:{
                    Scanner scan2 = new Scanner(System.in);
                    System.out.println("Enter the person's  Password ");
